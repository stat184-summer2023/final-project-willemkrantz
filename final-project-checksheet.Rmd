...
39(TheCube.csv) and 42(MTGOVintageCube.csv)


(B) .Rmd Line numbers for inspecting data intake:  

40 and 43 glimpse was used for both 
...
Lines 221-228 sucked out all creatures with the typing rogue.
...
lines 295-304
I know it isn't a true loop, but I tried my best.
